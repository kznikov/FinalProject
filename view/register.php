   ...
   <section id="content" role="main" class="container">
     <div id="register-panel">
        ...
        <div class="register-body">
        	...
        	<p>You'll need administrator credentials to log in to JIRA. Please provide an first name. last name, email address, username and password for your first administrator account. Make sure the password is secure. If you have account <a href="./index.php">Log in</a></p>

			<form id="jira-setup-account" action="" method="post">
				...
				<div class="form-group">
					...
					<div class="col-xs-12 col-md-10">
						<input class="form-control" type="text" name="jira-setup-account-field-lastname" id="jira-setup-account-field-lastname" placeholder="Type in a last name" required="required">
					</div>
				</div>
				<div class="form-group">
					<div class="col-xs-12 col-md-2">
